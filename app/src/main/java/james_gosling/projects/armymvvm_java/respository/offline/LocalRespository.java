...
public class LocalRespository {
    ...
    public LocalRespository(Application application){
    ...
    public void insert(Soldier soldier){
        new LocalRespository.OperationTasker(soldierDao , INSERT).execute(soldier);
    }

    public void update(Soldier soldier){
        new LocalRespository.OperationTasker(soldierDao , UPDATE).execute(soldier);
    }

    public void delete(Soldier soldier){
        new LocalRespository.OperationTasker(soldierDao , DELETE).execute(soldier);
    }
